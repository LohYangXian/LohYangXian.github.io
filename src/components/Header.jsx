...
function Header() {
    ...
    return (
        <header className="bg-gray-50">
            ...
            <div className="flex flex-1 items-center justify-end md:justify-between">
              <nav aria-label="Global" className="hidden md:block">
                <ul className="flex items-center gap-6 text-sm">
                  <li>
                    <ScrollAnchorTag to="aboutme" href="/">
                      About Me
                    </ScrollAnchorTag>
                  </li>

                  <li>
                    <ScrollAnchorTag to="experiences" href="/">
                      Experiences
                    </ScrollAnchorTag>
                  </li>

                  <li>
                    <ScrollAnchorTag to="projects" href="/">
                      Projects
                    </ScrollAnchorTag>
                  </li>

                  <li>
                    <button onClick={openModal} className="text-black transition  hover:text-gray-500/75" href="/">
                      Contact Me!
                    </button>
                    <Modal
                        isOpen={modalIsOpen}
          ...
          <div className="mt-5 mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
