...
import SelfPortraitLogo from '../assets/SelfPortraitLogo.jpeg'
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            >
              <div className="flex gap-4">
                ...
                <a
                  ...
                  className="block shrink-0 rounded-lg text-white bg-gray-900 p-2.5 shadow-sm font-medium"
                >
              ...
              >
                ...
                <p className="ms-2 hidden text-left text-xs sm:block">
                  <strong className="block font-medium">Loh Yang Xian</strong>
      
                  <span className="text-gray-500"> lohyangxian@u.nus.edu </span>
                </p>
          ...
          <div className="mt-8">
            ...
            <p className="mt-1.5 text-sm text-gray-500">
              Penultimate Business Analytics Student
            </p>
          </div>
        </div>
      </header>
